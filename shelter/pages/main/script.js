...
console.log("[+]Реализация слайдера-карусели на странице 36 (36)");
console.log("[+-]Реализация пагинации на странице  34 (36)");
console.log("[-]Реализация попап на обеих страницах 0 (14)");
console.log("Score 96 (110)");
// Бургер начало
